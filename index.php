                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-md-5 mx-md-4" id="card_body">
                                ...
                                <div class="text-center mt-5 <!-- pt-5-->">
                                    <a href="<?= env('APP_URL', './')?>" onclick="verCargandoAuth(this)">
                                ...
                                <div class="row mt-sm-5 position-relative">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-3 mb-3 flex-column">
                                            <a href="<?= env('URL_SISTEMA_ALMACEN', '#')?>" class="btn btn-lg btn-outline-dark" onclick="verCargandoAuth(this)">
                                        ...
                                        <div class="d-flex gap-3 flex-column mb-3">
                                            <a href="<?= env('URL_SISTEMA_TRANSPORTE', '#') ?>" class="btn btn-lg btn-outline-dark" onclick="verCargandoAuth(this)">
                                        ...
                                        <div class="d-flex d-none gap-3 flex-column mb-3">
                                            <a href="#" class="btn btn-lg btn-outline-dark" onclick="verCargandoAuth(this)">
